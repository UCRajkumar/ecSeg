...
def nuclei_segment(image, name, bbox_min_score, nms_thresh, resize_scale):
    ...
    saver.restore(sess, './models/nuset/whole_norm.ckpt')
    ...
    masks1 = sess.run(pred_masks, feed_dict={train_initial:image_normalized_wn})
